...
- El plazo para la entrega de estos desafíos es el **día antes de la siguente sesión de capacitación, a las 12:00 hrs**. En ese momento deberán subir a al canal de Teams de vuestro grupo la solución a los ejercicios.
...
- Al finalizar la actividad, cuando se envíe el listado de asistencia junto con la evaluación final, debe considerarse como **presente** a quien tenga inasistencia **justificada**. Internamente, lo ideal es mantenerlo como inasistencia justificada.
...
- (*) Lo anterior implica que solo las clases 1:4 tienen tarea, pues en la 5 se presenta la tarea final.
...
# Experiencias previas Capacitación en R

</br>
</br>
--

- .medium-par[Subdepto de Demografía y Estadísticas Vitales] (13 personas)

--

- .medium-par[Subdepto de Calidad Estadística] (11 personas)

--

- .medium-par[Depto de Gestión Estratégica] (16 personas)

--

- .medium-par[Capacitación R INE: Ciclo I] (82 internas / 15 externas)

--

- .medium-par[Total: **137 personas capacitadas**]

--

- .medium-par[Hay **56 personas** consideradas para el segundo ciclo]
...
.medium-par[Para quienes se integran:]
...
- Esta vez, por solicitud del grupo de profesoras/es, se asignarán personas a los horarios dispuestos por uds.
...
- Completar **encuesta individual de monitores en forms** (solo nuevos)

--

- De ser necesario, es posible generar una sesión para resolver dudas y reforzar contenidos con quienes lo deseen, especialmente quienes se incorporan como profesores/as.

--

- **Cada dupla:** Definir horario de disponibilidad en conjunto (cuidaremos que sean distintos horarios).

--

- Luego nosotros les asignaremos a los/as alumnos/as.

--

- Es posible que haya un proceso de reasignación de personas a grupos: lo coordinamos en conjunto.
...
- Capacitaciones comienzan la primera semana de septiembre.

--

- ¿Quien puede y quien no puede grabar en Teams?

--

- Una vez que tengan habilitado el permiso (los que no lo tenían) deben **cerrar sesión y volver a conectarse** para que la opción quede operativa.
...
- A la brevedad crearemos un Team y un canal para caga grupo de capacitación
...
- Además tendrán acceso a un **canal privado** de monitores/as
